...
@section('meta_description', 'Cardápio da La Torre Pizzaria e Sorveteria. Pizzas artesanais, sorvetes e muito mais. De
Terça a Domingo a partir das 18h. Peça pelo WhatsApp!')
        ...
        <div class="{{ $sectionClasses }}">
            ...
            <article class="menu-card {{ $category['cardClass'] }}" id="card-item-{{ $itemId }}">
                ...
                <div class="card-footer">
                    ...
                    <span class="card-price">R$ {{ number_format((float) $itemPrice, 2, ',', '.') }}</span>
